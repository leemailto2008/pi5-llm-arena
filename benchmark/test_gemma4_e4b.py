...
MODEL_BLOB = "/home/pi/.ollama/models/blobs/sha256-4c27e0f5b5adf02ac956c7322bd2ee7636fe3f45a8512c9aba5385242cb6e09a"
PORT = 9999
HOST = "127.0.0.1"

print("[*] Starting llama-server for gemma4:e4b...")
...
if not ready:
    print("[!] Failed to get ready state within 100s")
    proc.terminate()
    sys.exit(1)
